...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="scn-dialog">
      ...
      <script src="<?php echo ADMIN_PLUGINS_URL; ?>/shortcode_editor/tinymce/js/column-control.js" type="text/javascript"></script>
      
      <script src="<?php echo ADMIN_PLUGINS_URL.'/shortcode_editor/tinymce/js/dialog.js'; ?>" type="text/javascript"></script>
