var scnDialogHelper = {
  ...
  loadShortcodeDetails: function () {
    if (scnSelectedShortcodeType) {
      var a = this;
      jQuery.getScript(rvn.template_url + "/lib/backend/plugins/shortcode_editor/sc/" + scnSelectedShortcodeType + ".js", function () {
        a.initializeDialog()
      })
    }
  },
  ...
  previewAction: function (a) {
    ...
    jQuery("#scn-preview-iframe").attr("src", rvn.template_url+"/lib/backend/plugins/shortcode_editor/preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()))
  },
