...
if(!class_exists('rvn_latest_posts'))
{
  class rvn_latest_posts extends WP_Widget {
    ...
    ------------------------------------------------------------ */
  	...
  	function __construct() {
  		$widget_ops = array('classname' => 'widget_latest_posts', 'description' => __("Shows your latest portfolio entries", 'ruventhemes'));
  		
  		parent::__construct('latest_posts', __('CUSTOM: Latest Posts', 'ruventhemes'), $widget_ops);
    ...
    ------------------------------------------------------------ */
  	...
  	function widget($args, $instance) {
  		...
  		$title  = apply_filters('widget_title', empty($instance['title']) ? __('Latest Posts', 'ruventhemes') : $instance['title'], $instance, $this->id_base);
    ...
    ------------------------------------------------------------ */
  	...
  	function update($new_instance, $old_instance) {
  		...
  		if(isset($alloptions['widget_latest_posts']))
  			delete_option('widget_latest_posts');
    ...
    ------------------------------------------------------------ */
  	...
  	function form($instance) {
  		$instance = wp_parse_args((array)$instance, array(
  		  'title'  => __('Latest Posts', 'ruventhemes'),
  		  'number' => 3
  		));
...
if(class_exists('rvn_latest_posts'))
{
  ...
  function register_latest_posts_widget() {
  	register_widget('rvn_latest_posts');
  }
}
